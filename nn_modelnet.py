...
layer_fc2,l2= create_fc_layer(input=layer_fc1,
                     num_inputs=num_layer,
                     num_outputs=num_layer,
                     use_relu=True)
# layer_fc1=tf.layers.dropout(inputs=layer_fc2,rate=rate,training=True)
# layer_fc3,l3= create_fc_layer(input=layer_fc2,
#                      num_inputs=num_layer,
#                      num_outputs=num_layer,
#                      use_relu=True)
# dropout2=tf.layers.dropout(inputs=layer_fc3,rate=rate,training=True)
layer_fc4,l4= create_fc_layer(input=layer_fc2,
                     num_inputs=num_layer,
